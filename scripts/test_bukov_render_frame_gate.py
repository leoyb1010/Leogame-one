...
def record(
    *,
    ...
    return {
        ...
        "sessionP95Ms": p95,
        "sessionP99Ms": p99,
        "sessionFramesOver16_7Ms": over_16,
...
class RenderFrameGateTest(unittest.TestCase):
    ...
    def test_prefixed_logs_produce_exact_cumulative_dual_platform_summary(
        ...
        mac = self.write_log(
            ...
            "macOS",
            [
                record(frames=600, seconds=5.0, over_16=4, over_33=0),
                record(frames=1200, seconds=10.0, over_16=8, over_33=1),
            ],
        )
        ios = self.write_log(
            "ios.log",
        ...
        self.assertEqual(20, summary["aggregate"]["framesOver16_7Ms"])
    ...
    def test_rejects_gpu_counter_claim_and_cumulative_reset(self) -> None:
        ...
        reset_log = self.write_log(
            ...
            [
                ...
                record(frames=10, seconds=0.1, over_16=0, over_33=0),
            ],
        )
        with self.assertRaisesRegex(
